...
CREATE TABLE IF NOT EXISTS `agencias` (
  ...
  `nucepagencia` char(8) DEFAULT NULL COMMENT 'Número do CEP',
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Cadastro das Agências Bancárias';

INSERT INTO `agencias` (`fkbanco`, `pkagencia`, `txnomeagencia`, `fklogradouro`, `txcomplemento`, `nucepagencia`, `dtcriacao`, `dtcadagencia`) VALUES
...
CREATE TABLE IF NOT EXISTS `agenciastels` (
  ...
  `fktelefonetipo` smallint(5) unsigned DEFAULT NULL,
  `nutelefone` char(15) NOT NULL,
  `dtcadagenciatel` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Cadastro dos Telefones das Agências Bancárias';


DROP TABLE IF EXISTS `aplicacoesdascontas`;
CREATE TABLE IF NOT EXISTS `aplicacoesdascontas` (
  `pkaplicconta` smallint(5) unsigned NOT NULL,
  ...
  `dtcadaplicconta` date NOT NULL COMMENT 'Data de Geração do Registro.'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Cadastro das Aplicações Financeiras das Contas de Funcionários.';


DROP TABLE IF EXISTS `aplicacoesfinanceiras`;
CREATE TABLE IF NOT EXISTS `aplicacoesfinanceiras` (
  `pkaplicfinanceira` smallint(5) unsigned NOT NULL COMMENT 'PK da tabela',
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Cadastro das Aplicações Financeiras Disponíveis para os Funcionários com Contas em Agências Bancárias.';

INSERT INTO `aplicacoesfinanceiras` (`pkaplicfinanceira`, `txnomeaplicacao`, `txregrasdaaplicacao`, `dtcadaplicacao`) VALUES
	(1, 'Cardeneta de Poupança', 'Depósito feito em data que passa a referenciar o dia de pagamento dos juros referentes da aplicação', '2022-11-24'),
	(2, 'Cardeneta de Poupança multidata', 'Depósitos feitos em datas diferentes que passam a referenciar os dias de pagamentos dos juros referentes da aplicação', '2022-11-24'),
	(3, 'Depósito em Debentures Interbancários', 'Depósito feito em data que passa a referenciar o dia de pagamento dos juros referentes da aplicação', '2022-11-24'),
	(4, 'Depósito em Debentures do Banco', 'Depósito feito em data que passa a referenciar o dia de pagamento dos juros referentes da aplicação', '2022-11-24');

DROP TABLE IF EXISTS `areasdeestudos`;
CREATE TABLE IF NOT EXISTS `areasdeestudos` (
  `pkareadeestudo` smallint(6) unsigned NOT NULL COMMENT 'PK da Tabela',
  ...
  `dtcadareadeestudo` date DEFAULT NULL COMMENT 'Data de geração do registro'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Cadastro das Áreas de Estudos (interesses de estudos).';

INSERT INTO `areasdeestudos` (`pkareadeestudo`, `txnomearea`, `txdescricaoarea`, `dtcadareadeestudo`) VALUES
...
DROP TABLE IF EXISTS `areasdeestudoscursos`;
CREATE TABLE IF NOT EXISTS `areasdeestudoscursos` (
  `pkareadeestudocurso` smallint(5) unsigned NOT NULL COMMENT 'PK da tabela',
  `fkcurso` smallint(5) unsigned NOT NULL COMMENT 'FK indicando o código do Curso',
  `fkareadeestudo` smallint(5) unsigned NOT NULL COMMENT 'FK indicando o código da Área de Estudo',
  `dtcadareaestcurso` date DEFAULT NULL COMMENT 'Data de geração do registro',
  PRIMARY KEY (`pkareadeestudocurso`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Cadastro das Áreas de Estudos ligadas aos Cursos.';

INSERT INTO `areasdeestudoscursos` (`pkareadeestudocurso`, `fkcurso`, `fkareadeestudo`, `dtcadareaestcurso`) VALUES
	(1, 2, 1, '2022-11-24'),
	(2, 1, 1, '2022-11-24'),
	(3, 2, 3, '2022-11-24'),
	(4, 1, 3, '2022-11-24'),
...
DROP TABLE IF EXISTS `areasdeestudosdisciplinas`;
CREATE TABLE IF NOT EXISTS `areasdeestudosdisciplinas` (
  `pkareadeestudodisciplina` smallint(5) unsigned NOT NULL COMMENT 'PK da tabela',
  `fkdisciplina` smallint(5) unsigned NOT NULL COMMENT 'FK indicando o código da Disciplina.',
  `fkareadeestudo` smallint(5) unsigned NOT NULL COMMENT 'FK indicando o cód. Área de Estudo.',
  `dtcadareaestdisciplina` date NOT NULL COMMENT 'Data de geração do registro'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Cadastro das Áreas de Estudos ligadas às Disciplinas de Cursos.';

INSERT INTO `areasdeestudosdisciplinas` (`pkareadeestudodisciplina`, `fkdisciplina`, `fkareadeestudo`, `dtcadareaestdisciplina`) VALUES
	(1, 1, 1, '2022-11-24'),
	(2, 1, 5, '2022-11-24'),
	(3, 1, 8, '2022-11-24');

DROP TABLE IF EXISTS `areasdeestudoslivros`;
CREATE TABLE IF NOT EXISTS `areasdeestudoslivros` (
  `pkareadeestudolivro` smallint(5) unsigned NOT NULL COMMENT 'PK da tabela',
  `fklivro` smallint(6) unsigned NOT NULL COMMENT 'Parte da PK e FK indicando o código do livro',
  `fkareadeestudo` smallint(6) unsigned NOT NULL COMMENT 'Parte da PK e FK indicando o código da Área de Estudo',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Cadastro das Áreas de Estudos ligadas aos Livros.';

INSERT INTO `areasdeestudoslivros` (`pkareadeestudolivro`, `fklivro`, `fkareadeestudo`, `nugrauinfluencia`, `dtcadareaestlivro`) VALUES
	(1, 1, 2, 2, '2022-11-24'),
	(2, 1, 4, 2, '2022-11-24'),
	(3, 1, 7, 2, '2022-11-24');
...
CREATE TABLE IF NOT EXISTS `armazens` (
  ...
  `nuceparmazem` char(8) COLLATE utf8_bin DEFAULT NULL COMMENT 'CEP do endereço (sem traço)',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Cadastro dos Armazens';

INSERT INTO `armazens` (`pkarmazem`, `txnomearmazem`, `txdescricaogeral`, `fkcliente`, `fklogradouro`, `txcomplemento`, `nuceparmazem`, `nutelefone`, `qtarea`, `dtcadarmazem`) VALUES
...
CREATE TABLE IF NOT EXISTS `atividades` (
  ...
  `txdescricaoatividade` varchar(500) COLLATE utf8_bin DEFAULT NULL COMMENT 'Descrição detalhada e completa de uma atividade profissional.',
  `dtcadatividade` date NOT NULL COMMENT 'Data de geração do registro'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Cadastro das Atividades ';

INSERT INTO `atividades` (`pkatividade`, `txnomeatividade`, `txdescricaoatividade`, `dtcadatividade`) VALUES
	(1, 'Analise de requisitos', 'Executar a técnica de perguntas e respostas para obter referencias para determinar os requisitos funcionais e não funcionais', '2022-11-24'),
	(2, 'Determinação das parcelas do modelo conceitual', 'Executar a técnica de perguntas e respostas para obter referencias para determinar os requisitos funcionais e não funcionais', '2022-11-24'),
	(3, 'Análise de semântica de Dados & Processos', 'Executar a técnica de perguntas e respostas para obter referencias para determinar os requisitos funcionais e não funcionais', '2022-11-24'),
	(4, 'Determinação do Modelo Lógico', 'Executar a técnica de perguntas e respostas para obter referencias para determinar os requisitos funcionais e não funcionais', '2022-11-24'),
	(5, 'Analises técnicas de Dados&Processos', 'Executar a técnica de perguntas e respostas para obter referencias para determinar os requisitos funcionais e não funcionais', '2022-11-24'),
	(6, 'Determinação do Modelo Físico', 'Executar a técnica de perguntas e respostas para obter referencias para determinar os requisitos funcionais e não funcionais', '2022-11-24');

DROP TABLE IF EXISTS `atribuicoes`;
CREATE TABLE IF NOT EXISTS `atribuicoes` (
  `pkatribuicao` smallint(5) unsigned NOT NULL COMMENT 'PK da Tabela',
...
INSERT INTO `atribuicoes` (`pkatribuicao`, `fkprofessor`, `fkdisciplina`, `qthorasatribuidas`, `dtatribuicao`, `dtcadatribuicao`) VALUES
	(1, 2, 1, 80, '2023-01-02', '2023-01-02'),
	(2, 2, 2, 80, '2023-01-02', '2023-01-02'),
	(4, 11, 5, 80, '2023-01-02', '2023-01-02'),
	(5, 35, 5, 120, '2010-01-10', '2010-01-10'),
	(6, 6, 4, 40, '2010-01-01', '2010-01-02'),
	(7, 7, 3, 40, '2010-01-02', '2010-01-02');
...
CREATE TABLE IF NOT EXISTS `atuacoes` (
  ...
  `fktarefaprojeto` smallint(5) unsigned NOT NULL COMMENT 'FK indicando o código de Tarefa-Projeto',
  `dtinicio` date NOT NULL COMMENT 'Data de início de atuação do Funcionário no projeto',
...
INSERT INTO `atuacoes` (`pkatuacao`, `fkfuncionario`, `fktarefaprojeto`, `dtinicio`, `dttermino`, `qttempoduracao`, `dtcadatuacao`) VALUES
...
CREATE TABLE IF NOT EXISTS `autores` (
  ...
  `txcomplemento` varchar(80) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT 'Número do imóvel, localização referencial (outros imóveis próximos)',
  `nucepautor` char(8) DEFAULT NULL COMMENT 'CEP do endereço (sem traço)',
...
INSERT INTO `autores` (`pkautor`, `txnomeautor`, `fklogradouro`, `txcomplemento`, `nucepautor`, `dtnascimento`, `dtcadautor`) VALUES
...
CREATE TABLE IF NOT EXISTS `autorestels` (
  `pkautortel` smallint(6) NOT NULL COMMENT 'PK da Tabela',
...
CREATE TABLE IF NOT EXISTS `autorias` (
  `pkautoria` smallint(6) NOT NULL COMMENT 'PK da Tabela',
  `fklivro` smallint(6) unsigned NOT NULL COMMENT 'Parte da UK (com fkautor) e FK indicando o código do livro',
  `fkautor` smallint(6) unsigned NOT NULL COMMENT 'Parte da UK (com fklivro) e FK indicando o código do autor',
...
INSERT INTO `bairros` (`pkbairro`, `txnomebairro`, `fkcidade`, `dtcadbairro`) VALUES
	...
	(22, 'Vila Granada', 1, '2014-03-29'),
	(23, 'Vila Ré', 1, '2014-03-29'),
	(24, 'Arthur Alvin', 1, '2014-03-29'),
	(25, 'Cidade A.E. Carvalho', 1, '2014-03-29'),
	(26, 'Vila Guilhermina', 1, '2023-12-09'),
	(27, 'Vila Esperança', 1, '2023-12-04'),
	(28, 'Vila Talarico', 1, '2013-12-01');
...
CREATE TABLE IF NOT EXISTS `bancos` (
  ...
  `nucepbanco` char(8) DEFAULT NULL COMMENT 'Número do CEP',
...
INSERT INTO `bancos` (`pkbanco`, `txnomebanco`, `dtfundacao`, `aocompetencia`, `fklogradouro`, `txcomplemento`, `nucepbanco`, `dtcadbanco`) VALUES
	...
	('M09', 'Banco Itaucred Financiamentos', '1940-05-02', 'F', 460, '2500', '12345678', '2018-02-02');
...
INSERT INTO `capacitacoes` (`pkcapacitacao`, `fkcurso`, `fkfuncionario`, `dtcapacitacao`, `dtregistro`, `dtcadastro`) VALUES
	(1, 1, 25, '2010-10-10', '2010-10-10', '2010-10-15'),
	(2, 1, 34, '2010-12-20', '2010-12-20', '2010-12-20');
...
CREATE TABLE IF NOT EXISTS `cidades` (
  ...
  `fkestadodauniao` char(2) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `cidades` (`pkcidade`, `txnomecidade`, `txformaacesso`, `fkestadodauniao`, `qtpopulacao`, `qtarea`, `dtfundacao`, `dtcadcidade`) VALUES
	...
	(10, 'Andirá', 'rodovia e ferrovia', 'AC', 65000.00, 280, '2018-01-31', '2018-01-31'),
	...
	(14, 'Ourinhos', 'Rodovia Raposo Tavares + Rodovia Orlando Quagliato + Rodovia Transbrasiliana', 'SP', 125000.00, 130, '1918-12-12', '2022-12-13');
...
CREATE TABLE IF NOT EXISTS `clientes` (
  ...
  `nucepcliente` char(8) COLLATE utf8_bin NOT NULL COMMENT 'Número do CEP - somente números',
  `aosituacao` char(1) COLLATE utf8_bin DEFAULT NULL COMMENT 'Atributo Operacional A-Ativo | B-Bloqueado | Desligado',
  `vllimitecompra` decimal(15,2) NOT NULL COMMENT 'Valor limite de compra para o cliente',
  `nutelefone` char(13) COLLATE utf8_bin DEFAULT NULL COMMENT 'Núemro do telefone - somente números.',
  `txnomecontato` varchar(90) COLLATE utf8_bin DEFAULT NULL COMMENT 'Nome da pessoa que atende no telefone do Cliente',
...
INSERT INTO `clientes` (`pkcliente`, `txnomecliente`, `txrazaosocial`, `fklogradouro`, `txcomplemento`, `nucepcliente`, `aosituacao`, `vllimitecompra`, `nutelefone`, `txnomecontato`, `dtcadcliente`) VALUES
	(5, 'Vem que tem', 'Bijuterias e adereços Vem que Tem S/C Ltda.', 390, ' 150', '43453456', 'A', 1000.00, NULL, NULL, '2011-10-24'),
	(10, 'Tratoria do Sargento', 'Ristoranti Il Tratoria do Sargento', 600, ' 985', '65787678', 'A', 25000.00, NULL, NULL, '2007-02-02'),
	(15, 'Restaurante Bom Vivan', 'Restaurante "O Bom Vivan" S/C Ltda.', 550, ' 567', '56784567', 'B', 5000.00, NULL, NULL, '2009-12-10'),
	(20, 'Tratoria do Sargento', 'Restaurante da Tratoria do Sargento S/C Ltda.', 460, ' 1254', '04152415', 'A', 12000.00, NULL, NULL, '2011-06-01'),
	(25, 'Tratoria do Pirata', 'Ristoranti tre fratelli S.A.', 220, ' 1492', '12345678', 'A', 30000.00, NULL, NULL, '2007-01-20'),
	(30, 'Mc Donalds', 'Rest Com S/A ', 610, ' 6500', '14785214', 'B', 100000.00, NULL, NULL, '2008-01-20'),
	(35, 'La Traviatta Ripante', 'Rest Com S/A ', 380, ' 125 - 15And Ap 156', '45685236', 'A', 100000.00, NULL, NULL, '2008-01-20'),
	(40, 'Bistro Ratatui', 'Restaurante e Bisro Ratatui S/C Ltda.', 520, ' 1245', '19584756', 'D', 3456.00, NULL, NULL, '2011-10-22'),
	(45, 'teste de ALTERAÇÃO', 'teste sem razão', 180, '1452', '01455236', 'D', 15000.00, NULL, NULL, '2012-10-10'),
	(55, 'CAIO', 'Companhia Americana de Industria de Ônibus S/C Ltda.', 220, '1234', '01455236', 'A', 150000.00, '11556782345', 'Luis Antonio', '2012-10-10'),
	(56, 'AVOA', 'Auto Viação Ourinhos Assis S/C Ltda.', 610, '4500', '19784562', 'A', 25000.00, '1433257845', 'Maria Antonia', '2010-10-10');
...
CREATE TABLE IF NOT EXISTS `clientestels` (
  ...
  `fktelefonetipo` smallint(6) unsigned DEFAULT NULL COMMENT 'FK para a tabela telefonestipos',
  `nutelefone` char(15) COLLATE utf8_bin NOT NULL COMMENT 'Número do telefone (somente os números)',
...
INSERT INTO `clientestels` (`pkclientetel`, `fkcliente`, `fktelefonetipo`, `nutelefone`, `dtcadclientetel`) VALUES
	(0, 5, 3, '', '2022-11-29'),
	(1, 10, 2, '', '2022-11-30'),
	(2, 10, 5, '', '2022-11-30');
...
INSERT INTO `consultas` (`pkconsulta`, `fkmedico`, `dthoraconsulta`, `fkfuncionario`, `dthorarealizada`, `fkplanodesaude`, `aosituacaoconsulta`, `dtcadconsulta`) VALUES
	...
	(28, NULL, '2018-04-25 07:00:00', 8, '2018-04-28 07:00:00', 5, 'R', '2018-04-20'),
	(29, NULL, '2018-04-25 07:20:00', 11, '2018-04-28 07:22:00', 5, 'R', '2018-04-20'),
	(30, NULL, '2018-04-25 07:40:00', 15, '2018-04-28 07:40:00', 5, 'R', '2018-04-20'),
	(31, NULL, '2018-04-25 08:00:00', 16, '2018-04-28 08:00:00', 5, 'R', '2018-04-20'),
	(32, NULL, '2018-04-25 08:20:00', 20, '2018-04-28 08:22:00', 5, 'R', '2018-04-20'),
	(33, NULL, '2018-04-25 08:40:00', 23, '2018-04-28 08:40:00', 5, 'R', '2018-04-20'),
	(34, NULL, '2018-04-25 09:00:00', 30, '2018-04-28 09:00:00', 5, 'R', '2018-04-20'),
	(35, NULL, '2018-04-25 09:20:00', 26, '2018-04-28 09:22:00', 5, 'R', '2018-04-20'),
	(36, NULL, '2018-04-25 09:40:00', 30, '2018-04-28 09:40:00', 5, 'R', '2018-04-20'),
	(37, NULL, '2018-04-25 10:00:00', 10, '2018-04-28 10:00:00', 5, 'R', '2018-04-20'),
	(38, NULL, '2018-04-25 10:20:00', 12, '2018-04-28 10:22:00', 5, 'R', '2018-04-20'),
	(39, NULL, '2018-04-25 10:40:00', 13, '2018-04-28 10:40:00', 5, 'R', '2018-04-20'),
	(40, NULL, '2018-04-25 11:00:00', 22, '2018-04-28 11:00:00', 5, 'R', '2018-04-20'),
	(41, NULL, '2018-04-25 11:20:00', 15, '2018-04-28 11:22:00', 5, 'R', '2018-04-20'),
	(42, NULL, '2018-04-25 11:40:00', 19, '2018-04-28 11:40:00', 5, 'R', '2018-04-20'),
	(43, NULL, '2018-04-25 14:00:00', 18, '2018-04-28 14:00:00', 5, 'R', '2018-04-20'),
	(44, NULL, '2018-04-25 14:20:00', 21, '2018-04-28 14:22:00', 5, 'R', '2018-04-20'),
	(45, NULL, '2018-04-25 14:40:00', 24, '2018-04-28 14:40:00', 5, 'R', '2018-04-20'),
	(46, NULL, '2018-04-25 15:00:00', 25, '2018-04-28 15:00:00', 5, 'R', '2018-04-20'),
	(47, NULL, '2018-04-25 15:20:00', 17, '2018-04-28 15:22:00', 5, 'R', '2018-04-20'),
	(48, NULL, '2018-04-25 15:40:00', 29, '2018-04-28 15:40:00', 5, 'R', '2018-04-20'),
	(49, NULL, '2018-04-25 16:00:00', 31, '2018-04-28 16:00:00', 5, 'R', '2018-04-20'),
	(50, NULL, '2018-04-25 16:20:00', 32, '2018-04-28 16:22:00', 5, 'R', '2018-04-20'),
	(51, NULL, '2018-04-25 16:40:00', 41, '2018-04-28 16:40:00', 5, 'R', '2018-04-20'),
	(52, NULL, '2018-04-25 17:00:00', 35, '2018-04-28 17:00:00', 5, 'R', '2018-04-20'),
	(53, NULL, '2018-04-25 17:20:00', 36, '2018-04-28 17:22:00', 5, 'R', '2018-04-20'),
	(54, NULL, '2018-04-25 17:40:00', 40, '2018-04-28 17:40:00', 5, 'R', '2018-04-20'),
	...
	(109, 45, '2022-12-06 00:00:00', 15, '2022-12-06 00:00:00', 1, 'R', '2022-12-13'),
	(110, 5, '2022-12-05 00:00:00', 1, '2022-12-05 00:00:00', 1, 'R', '2022-12-13');
...
CREATE TABLE IF NOT EXISTS `contas` (
  ...
  `fkcontatipo` smallint(5) unsigned DEFAULT NULL COMMENT 'FK com o código do tipo de conta bancária.',
...
INSERT INTO `contas` (`fkbanco`, `fkagencia`, `nuconta`, `fkfuncionario`, `fkcontatipo`, `dtcriacao`, `dtcadconta`) VALUES
	('001', '0001', '9834435', 20, 1, '2010-10-10', '2010-10-10'),
	('002', '0001', '1234435', 20, 1, '2022-11-24', '2022-11-24'),
	('002', '0001', '9834435', 20, 1, '2022-11-24', '2022-11-24'),
	('184', '0001', '1234123', 20, 1, '2022-11-24', '2022-11-24'),
	('184', '0001', '1785123', 20, 1, '2022-11-24', '2022-11-24');

DROP TABLE IF EXISTS `contastipos`;
CREATE TABLE IF NOT EXISTS `contastipos` (
  `pkcontatipo` smallint(5) unsigned NOT NULL COMMENT 'PK da tabela.',
  `txnomecontatipo` varchar(90) NOT NULL COMMENT 'Descrição do tipo de conta bancária.',
  `dtcadcontatipo` date NOT NULL COMMENT 'Data de geração do registro'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Cadastro dos tipos de contas bancárias.';

INSERT INTO `contastipos` (`pkcontatipo`, `txnomecontatipo`, `dtcadcontatipo`) VALUES
...
CREATE TABLE IF NOT EXISTS `cursos` (
  ...
  `fkinstituicaodeensino` smallint(5) unsigned DEFAULT NULL COMMENT 'FK com o código da instituição de ensino.',
  `fkniveldeeducacao` smallint(5) unsigned DEFAULT NULL COMMENT 'FK com o código do nível de educação.',
...
INSERT INTO `cursos` (`pkcurso`, `txnomecurso`, `fkinstituicaodeensino`, `fkniveldeeducacao`, `qtcargahoraria`, `dtcadcurso`) VALUES
	(1, 'Matemática', 5, 1, 2200, '2018-07-06'),
	(2, 'Biologia', 6, 6, 2200, '2022-11-24'),
	(3, 'Análise de táquions no CERN', 3, 8, 440, '2010-10-10');
...
INSERT INTO `departamentos` (`pkdepto`, `txnomedepto`, `fkfuncionariogerente`, `fkdeptosuperior`, `txlocalizacao`, `qtareatotal`, `dtcriacaodepto`, `dtcaddepartamento`) VALUES
	...
	('R99', 'Retenções de objetos perdidos nos trens', 7, 'D11', 'Superior da Estação #45', 5000, '2022-11-28', '2022-11-28');
...
CREATE TABLE IF NOT EXISTS `disciplinas` (
  ...
  `txnomedisciplina` varchar(250) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'Nome usual completo (sem abreviações)',
...
INSERT INTO `disciplinas` (`pkdisciplina`, `fkcurso`, `txnomedisciplina`, `txementa`, `qthoras`, `dtcaddisciplina`) VALUES
	(1, 1, 'Cálculo I', 'limites e derivadas', 180, '2022-11-02'),
	(2, 1, 'Calculo II', 'limites e derivadas', 180, '2022-11-01'),
	(3, 1, 'Calculo III', 'limites e derivadas', 180, '2022-11-02'),
	(4, 1, 'Calculo IV', 'limites e derivadas', 180, '2022-11-01'),
	(5, 2, 'Física I', 'Uau... n', 160, '2010-10-10');
...
CREATE TABLE IF NOT EXISTS `editoras` (
  ...
  `nucepeditora` char(8) COLLATE utf8_bin DEFAULT NULL COMMENT 'Número do CEP',
...
INSERT INTO `editoras` (`pkeditora`, `txnomeeditora`, `txrazaosocial`, `fklogradouro`, `txcomplemento`, `nucepeditora`, `dtcadeditora`) VALUES
	(1, 'Editora Abril', 'Abril Editora S/C Ltda.', 450, ' 1234', '12345678', '2010-10-10'),
	...
	(6, 'Editora Erica', 'Editora Erica S.C. Ltda.', 130, '4500', '33453453', '2022-12-13');
...
CREATE TABLE IF NOT EXISTS `empresas` (
  ...
  `txcomplemento` varchar(80) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT 'Número do imóvel, localização referencial (outros imóveis próximos)',
  `nucepempresa` char(8) DEFAULT NULL COMMENT 'Número do CEP',
  `fksetordeatuacao` smallint(6) unsigned DEFAULT NULL COMMENT 'FK com o código do setor de atuação da empresa.',
...
INSERT INTO `empresas` (`pkempresa`, `txnomeusual`, `txrazaosocial`, `fklogradouro`, `txcomplemento`, `nucepempresa`, `fksetordeatuacao`, `dtcadempresa`) VALUES
	...
	(5, 'Panasonic', 'Panasonic Do Brasil  Ltda', 60, '21451', '21211111', 1, '2018-07-06'),
	(6, 'Nestlé', 'Industria de Produtos Alimentícios Nestlé S.A.', 220, '5205 - Cj. 5234', '01145422', 1, '2010-10-10'),
	(7, 'Hikari', 'Processadora de grãos Hikari S/C Ltda.', 590, 'Km 43', '43451120', 3, '1995-05-10');
...
CREATE TABLE IF NOT EXISTS `especialidadesmedicas` (
  `pkespecmedica` smallint(6) unsigned NOT NULL COMMENT 'PK da Tabela',
  `txnomeespecmedica` varchar(200) COLLATE utf8_bin NOT NULL COMMENT 'Nome usual completo (sem abreviações)',
...
INSERT INTO `especialidadesmedicas` (`pkespecmedica`, `txnomeespecmedica`, `dtcadespecmedica`) VALUES
...
CREATE TABLE IF NOT EXISTS `estadosdauniao` (
  `pkestadodauniao` char(2) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'PK da Tabela. É a sigla do Estado da União Federativa.',
  ...
  `dtcadestadodauniao` date NOT NULL COMMENT 'Data de geração do registro'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Cadastro com os estados da união Federativa do Brasil';

INSERT INTO `estadosdauniao` (`pkestadodauniao`, `txnome`, `txcapital`, `qtareatotal`, `qtpopulacao`, `dtcadestadodauniao`) VALUES
...
INSERT INTO `execucoes` (`pkexecucao`, `fkservico`, `fkveiculo`, `fkoficina`, `dtexecucaoservico`, `nudiasprevistos`, `nudiasrealizados`, `dtrealentrega`, `txdescricaoproblema`, `txdescricaosolucao`, `dtcadexecucao`) VALUES
	(1, 1, 2, 10, '2022-11-29', 4, 4, '2022-12-03', 'amortecedores', 'troca', '2022-11-29'),
	(3, 4, 4, 10, '2019-04-05', 2, 1, '2019-04-05', 'Quando dá uma arrancada com marchas baixas, no final do ciclo, ouve-se um trepidar como um vibrar de metal.', 'vibração no peito de açõ do kart ou braçadeiras soltas no escapamento.', '2019-04-06'),
	(4, 3, 1, 15, '2020-05-10', 2, 2, '2020-05-11', 'Quando se faz uma curva suave para esquerda em 30 km/h e se pisa levemente no freio ouve-se um ronco aparentemente na roda dianteira esquerda.', 'Aparentemente o freio à disco pode estar empenado.', '2020-05-11');

DROP TABLE IF EXISTS `fabricantes`;
CREATE TABLE IF NOT EXISTS `fabricantes` (
  `pkfabricante` smallint(5) unsigned NOT NULL COMMENT 'PK da Tabela',
  `txnomefabricante` varchar(250) NOT NULL COMMENT 'Nome usual completo (sem abreviações)',
  ...
  `txcomplemento` varchar(80) DEFAULT NULL COMMENT 'Número do imóvel, localização referencial (outros imóveis próximos)',
  `nucepfabricante` char(8) DEFAULT NULL COMMENT 'Número do CEP',
...
INSERT INTO `fabricantes` (`pkfabricante`, `txnomefabricante`, `txrazaosocial`, `fklogradouro`, `txcomplemento`, `nucepfabricante`, `dtcadfabricante`) VALUES
	...
	(9, 'BYD', 'Insudstria de Veículos Elericos', 10, '15000', '11452145', '2010-10-10');
...
CREATE TABLE IF NOT EXISTS `fabricantestels` (
  ...
  `fktelefonetipo` smallint(6) unsigned DEFAULT NULL,
  `nutelefone` char(15) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `faturascompras` (
  `pkfaturacompra` smallint(6) unsigned NOT NULL COMMENT 'PK da Tabela',
  `fknunfcompra` smallint(6) unsigned DEFAULT NULL COMMENT 'FK para a tabela nfvendas ou nfcompras (depende do valor de aotiponota)',
  ...
  `dtcriacaofatura` date NOT NULL COMMENT 'Data de criação da fatura no sistema contábil.',
...
CREATE TABLE IF NOT EXISTS `faturasvendas` (
  `pkfaturavenda` smallint(6) unsigned NOT NULL COMMENT 'PK da Tabela',
  `fknunfvenda` smallint(6) unsigned DEFAULT NULL COMMENT 'FK para a tabela nfvendas ou nfcompras (depende do valor de aotiponota)',
  `dtvencimento` date DEFAULT NULL COMMENT 'Data de vencimento da fatura',
  `vlfatura` decimal(10,0) DEFAULT NULL COMMENT 'Valor bruto da fatura',
  `vldesconto` decimal(10,0) NOT NULL COMMENT 'Valor de desconto',
  `vlliquido` decimal(10,0) NOT NULL COMMENT 'Valor Líquido',
...
INSERT INTO `feitospor` (`pkfeitospor`, `fkoficina`, `fkservico`, `txdescricaocomplementar`, `dtcadfeitospor`) VALUES
	(1, 15, 3, 'Balanceamento físico (rotor de roda)', '2010-10-10'),
	(2, 15, 2, 'Todas as marcas de pneus, mas preferencia para Continental', '2010-10-10'),
	(3, 15, 1, 'Amortederes Confap', '2010-10-10'),
	(4, 10, 4, 'Trabalhamos com todas as marcas.', '2010-10-10');

DROP TABLE IF EXISTS `fornecedores`;
CREATE TABLE IF NOT EXISTS `fornecedores` (
  `pkfornecedor` smallint(5) unsigned NOT NULL COMMENT 'PK da Tabela',
  `txnomefornecedor` varchar(250) COLLATE utf8_bin DEFAULT NULL COMMENT 'Nome usual completo (sem abreviações)',
  `txrazaosocial` varchar(250) COLLATE utf8_bin DEFAULT NULL COMMENT 'Razão social completa.',
  `fklogradouro` int(10) unsigned DEFAULT NULL COMMENT 'FK com o código do logradouro do fornecedor',
  `txcomplemento` varchar(25) COLLATE utf8_bin DEFAULT NULL COMMENT 'Número do imóvel, localização referencial (outros imóveis próximos)',
  `nucepfornecedor` char(8) COLLATE utf8_bin DEFAULT NULL COMMENT 'Número do CEP',
  `vllimitevenda` double(15,2) unsigned NOT NULL COMMENT 'Valor limite de venda do fornecedor para a empresa.',
...
INSERT INTO `fornecedores` (`pkfornecedor`, `txnomefornecedor`, `txrazaosocial`, `fklogradouro`, `txcomplemento`, `nucepfornecedor`, `vllimitevenda`, `dtcadfornecedor`) VALUES
...
INSERT INTO `fornecimentos` (`pkfornecimento`, `fkproduto`, `fkfornecedor`, `dtultimofornecimento`, `vlultimofornecimento`, `dtcadfornecimento`) VALUES
	(1, 1, 1, '2022-11-28', 4500.00, '2022-12-06'),
	(3, 3, 4, '2022-11-28', 4500.00, '2022-12-06');
...
CREATE TABLE IF NOT EXISTS `funcionarios` (
  ...
  `txcomplemento` varchar(25) COLLATE utf8_bin DEFAULT NULL COMMENT 'Número do imóvel, localização referencial (outros imóveis próximos)',
  `nucepfuncionario` char(8) COLLATE utf8_bin DEFAULT NULL COMMENT 'Número do CEP',
  `dtcontratacao` date NOT NULL COMMENT 'Data de contratação',
  `fkniveldeeducacao` smallint(6) unsigned DEFAULT NULL COMMENT 'FK com o código do nível de educação (escolaridade)',
...
INSERT INTO `funcionarios` (`pkfuncionario`, `txprenome`, `txsobrenome`, `fkdepto`, `fkfuncao`, `nuramal`, `fklogradouro`, `txcomplemento`, `nucepfuncionario`, `dtcontratacao`, `fkniveldeeducacao`, `aosexo`, `dtnascimento`, `txresenha`, `vlsalario`, `vlbonus`, `vlcomissao`, `dtcadfuncionario`) VALUES
...
INSERT INTO `funcionariosplanos` (`pkfuncionarioplano`, `fkfuncionario`, `fkplanodesaude`, `dtvinculacao`, `dtdesligamento`, `dtcadfuncionarioplano`) VALUES
	(1, 15, 2, '2006-10-10', '2007-10-10', '2018-02-12 15:30:00'),
...
CREATE TABLE IF NOT EXISTS `funcionariostels` (
  ...
  `fktelefonetipo` smallint(5) unsigned DEFAULT NULL COMMENT 'FK para a tabela telefonestipos',
  `nutelefone` char(15) COLLATE utf8_bin NOT NULL COMMENT 'Número do telefone (somente os números)',
...
INSERT INTO `funcionariostels` (`pkfuncionariotel`, `fkfuncionario`, `fktelefonetipo`, `nutelefone`, `dtcadfuncionariotel`) VALUES
	(1, 34, 4, '14985625645', '2021-12-07'),
	(2, 34, 1, '1433255623', '2021-12-01');
...
INSERT INTO `habilitacoes` (`pkhabilitacao`, `fkcurso`, `fkprofessor`, `dthabilitacao`, `dtcapacitacao`, `dtcadhabilitacao`) VALUES
	(1, 1, 5, '2019-10-15', '2019-10-10', '2019-10-16'),
	(2, 1, 2, '2019-10-15', '2019-10-10', '2019-10-16'),
	(3, 2, 7, '2019-10-15', '2019-10-10', '2019-10-16');
...
INSERT INTO `historicoprofissional` (`pkhistorico`, `fkfuncionario`, `fkempresa`, `fktarefa`, `dtinicio`, `dttermino`, `dtcadhistorico`) VALUES
	(1, 34, 1, 10, '2010-10-10', '2010-10-15', '2023-12-10');
...
CREATE TABLE IF NOT EXISTS `instensinoniveiseduc` (
  ...
  `fkinstituicaodeensino` smallint(5) unsigned NOT NULL COMMENT 'FK para a tabela instituições de ensino',
  `fkniveldeeducacao` smallint(5) unsigned NOT NULL COMMENT 'FK para a tabela niveisdeeducacao.',
...
DROP TABLE IF EXISTS `instituicoesdeensino`;
CREATE TABLE IF NOT EXISTS `instituicoesdeensino` (
  `pkinstituicaodeensino` smallint(6) unsigned NOT NULL COMMENT 'PK da Tabela',
  ...
  `txcomplemento` varchar(80) COLLATE utf8_bin DEFAULT NULL COMMENT 'Número do imóvel, localização referencial (outros imóveis próximos)',
  `nucepinstituicao` char(8) COLLATE utf8_bin DEFAULT NULL COMMENT 'Número do CEP do logradouro da instituição de ensino',
...
INSERT INTO `instituicoesdeensino` (`pkinstituicaodeensino`, `txnomeinstituicao`, `fklogradouro`, `txcomplemento`, `nucepinstituicao`, `dtfundacao`, `dtcadinstituicaoensino`) VALUES
	(1, 'Faculdade de Belas Artes', 60, ' 1500', '12767890', '1901-01-10', '2001-01-10'),
	(2, 'Faculdade de Arquitetura de Urbanismo de S', 120, ' 500', '', '1901-01-10', '2001-01-10'),
	...
	(7, 'Faculdade de Medicina de Ribeirão Preto [USP]', NULL, NULL, NULL, '1958-10-28', '2023-10-28'),
	(8, 'Instituto de Tecnologia da USP-São Carlos', 60, '15425', '15121521', '1990-02-05', '2000-10-10');

DROP TABLE IF EXISTS `instituicoestels`;
CREATE TABLE IF NOT EXISTS `instituicoestels` (
  `pkinstituicaodeensinotel` smallint(6) NOT NULL COMMENT 'PK da Tabela',
  `fkinstituicaodeensino` smallint(6) NOT NULL COMMENT 'FK para a tabela instituições de ensino',
  `fktelefonetipo` smallint(6) DEFAULT NULL COMMENT 'FK para a tabela telefonestipos',
  `nutelefone` char(15) COLLATE utf8_bin NOT NULL COMMENT 'Número do telefone (somente os números)',
...
CREATE TABLE IF NOT EXISTS `inventarios` (
  `pkinventario` smallint(6) NOT NULL COMMENT 'PK da Tabela',
  `fkproduto` smallint(6) unsigned NOT NULL DEFAULT 0 COMMENT 'Parte da UK1 (com fkfuncionario e dtinventario) e FK indicando o código do produto.',
  `fkfuncionario` smallint(6) unsigned NOT NULL DEFAULT 0 COMMENT 'Parte da UK1 (com fkproduto e dtinventario) e FK indicando o código do funcionário.',
  `dtinventario` date NOT NULL COMMENT 'Parte da UK1 (com fkproduto e fkfuncionario) é a Data de realização do inventário de estoque.',
...
INSERT INTO `inventarios` (`pkinventario`, `fkproduto`, `fkfuncionario`, `dtinventario`, `qtestoque`, `txlocal`, `dtcadinventario`) VALUES
	(5, 1, 4, '2018-04-10', 2000.00, 'Galpão principal do estoque da fábrica', '2018-04-12'),
	(10, 2, 4, '2018-04-10', 1500.00, 'Galpão principal do estoque da fábrica', '2018-04-12'),
	(15, 2, 19, '2018-04-10', 4000.00, 'Galpão principal do estoque da fábrica', '2018-04-12'),
	(20, 4, 9, '2018-04-10', 1500.00, 'Galpão principal do estoque da fábrica', '2018-04-12'),
	(25, 4, 10, '2018-04-10', 1800.00, 'Galpão principal do estoque da fábrica', '2018-04-12');
...
INSERT INTO `livros` (`pklivro`, `txtituloacervo`, `fkeditora`, `dtpublicacao`, `nuanopublicacao`, `qtexemplaresacervo`, `qtexemplaresconsulta`, `dtcadlivro`) VALUES
	...
	(2, 'Anjos caídos', 1, '2020-10-10', '2020', 150, 20, '2020-10-10');
...
CREATE TABLE IF NOT EXISTS `medicos` (
  ...
  `nucrm` mediumint(9) NOT NULL DEFAULT 0 COMMENT 'Número do registro do médico no Conselho Regional dos médicos.',
  `fkespecmedica` smallint(5) unsigned DEFAULT NULL COMMENT 'FK com o código da especmedica médica',
  `fkinstituicaodeensino` smallint(5) unsigned DEFAULT NULL COMMENT 'FK com o código da Instituição de Ensino onde o médico se formou.',
  ...
  `nutelemoradia` char(13) DEFAULT NULL COMMENT 'Número do Telefone da moradia do Médico',
  ...
  `nuteleclinica` char(13) DEFAULT NULL COMMENT 'Número do Telefone da clínica do médico',
...
INSERT INTO `medicos` (`pkmedico`, `txnomemedico`, `nucrm`, `fkespecmedica`, `fkinstituicaodeensino`, `fklogradouromoradia`, `txcomplementomoradia`, `nucepmoradia`, `nutelemoradia`, `fklogradouroclinica`, `txcomplementoclinica`, `nucepclinica`, `nuteleclinica`, `aosituacao`, `dtcadmedico`) VALUES
	(5, 'Marina Emanuela Carolina Bizeo', 8388607, 2, 6, 350, '1452 - Ap145', '14124145', NULL, 490, '748', '04312456', NULL, 'D', '2018-04-26'),
	(40, 'Rui de Alcantara Brandão', 8388607, 2, 6, 220, '4560 - ap.545', '12334123', '', 300, '2500 - 4and - cj45', '12234124', '', 'D', '2012-10-10'),
	(45, 'Olavo de Almeida Buarque Ramos', 8388607, 5, 1, 610, '4500', '87654321', '123123', 450, '145', '77776666', '123123123', 'D', '2012-10-10'),
	(55, 'Daniel Roberto Alves da Silva', 8388607, 1, 6, 350, '1452', '04511452', NULL, 350, '1452', '04511452', NULL, 'A', '2012-10-10'),
	(60, 'Leonardo Egídio Wolf Rubenstein', 8388607, 1, 6, 350, '1452', '04511452', NULL, 350, '1452', '04511452', NULL, 'D', '2012-10-10'),
	(65, 'Dalila Emanuelle D', 8388607, 1, 1, 350, '1452', '04511452', '2523542345234', 350, '1452', '04511452', '234523452435', 'A', '2012-10-10'),
	(66, 'Asdrubal De Albuquerque Lins', 8388607, 6, 6, 130, '456', '99887766', '113241234', 60, '4500 bloco 2 conjunto 2', '98787871', '1103948530', 'D', '2022-10-30'),
	(67, 'Ataulfo de Andrade Filho', 5555555, 3, 6, 50, '2556 - Ap. 2356', '07514817', '', 300, '456 - 15ºAndar - Cj. 1509', '04512451', '', 'A', '2023-10-10'),
	(68, 'Alberto de Oliveira', 8388607, 1, 6, 60, '345', '35463564', '234562546', 180, '436', '3456345', '34563456', 'A', '0000-00-00'),
	(69, 'Alvaro de Mesquita Spindola', 88888, 5, 7, 450, '2345', '23452345', '3456245623245', 60, '345', '34535345', '3453453', 'A', '2023-10-10'),
	(70, 'Ataulfo de Athaide Alves Albuquerque Aguiar Aragão', 878787, 7, 6, 330, '765', '45645645', '5556756756756', 180, '567', '86784567', '2123423423423', 'A', '2023-07-11'),
	(71, 'Maria Fernanda Custódio de Mello', 435968, 2, 7, 350, '1450 - ap.259', '22345823', '1123423444', 330, '450 - 15º - cj. 1508', '34566345', '1124352345', 'A', '2023-11-08'),
	(72, 'Alaor De Albuquerque Lins', 678, 2, 6, 180, '456 - Casa 45', '12341234', '123412341234', 460, '3456', '12341234', '1122234234', 'A', '2023-11-07'),
	(73, '', 0, 0, 0, 0, '', '', NULL, 0, '', '', NULL, '', '0000-00-00');
...
CREATE TABLE IF NOT EXISTS `movimentos` (
  ...
  `fkmovimentotipo` smallint(6) unsigned DEFAULT NULL COMMENT 'FK com o código do tipo de movimento',
...
INSERT INTO `movimentos` (`pkmovimento`, `fklivro`, `fkfuncionario`, `dtmovimento`, `fkmovimentotipo`, `dtprevistadevolucao`, `dtrealdevolucao`, `dtcadmovimento`) VALUES
	(1, 1, 7, '0000-00-00 00:00:00', 1, '2022-12-06', '0000-00-00', '2022-12-06');

DROP TABLE IF EXISTS `movimentostipos`;
CREATE TABLE IF NOT EXISTS `movimentostipos` (
  `pkmovimentotipo` smallint(6) unsigned NOT NULL COMMENT 'PK da Tabela',
...
INSERT INTO `movimentostipos` (`pkmovimentotipo`, `txnometipomov`, `aopermiteretirada`, `dtcadmovtipo`) VALUES
...
CREATE TABLE IF NOT EXISTS `nfcompras` (
  ...
  `fkfuncionario` smallint(6) unsigned DEFAULT NULL COMMENT 'FK com o código do funcionário que registra a nota no sistema.',
...
INSERT INTO `nfcompras` (`pknunfcompra`, `fkfornecedor`, `nunotafiscal`, `txnaturezaoperacao`, `nucfop`, `dtnfcompra`, `fkfuncionario`, `vltotalnfcompra`, `aosituacao`, `txcomentarios`, `dtcadnfcompra`) VALUES
	(1, 3, 15250, 'A1', 500, '2023-12-11', 9, 2400.00, 'A', '', '2023-12-11');
...
CREATE TABLE IF NOT EXISTS `nfvendas` (
  `pknunfvenda` smallint(6) unsigned NOT NULL COMMENT 'PK da Tabela – número da nota fiscal',
...
CREATE TABLE IF NOT EXISTS `nfvendasitens` (
  `fknunfvenda` smallint(6) unsigned NOT NULL COMMENT 'Parte da PK e FK com o código da nota fiscal de venda',
...
CREATE TABLE IF NOT EXISTS `niveisdeeducacao` (
  `pkniveldeeducacao` smallint(6) unsigned NOT NULL COMMENT 'PK da Tabela',
...
INSERT INTO `niveisdeeducacao` (`pkniveldeeducacao`, `txnomecomum`, `qtanosdeestudo`, `dtcadniveleducacao`) VALUES
...
CREATE TABLE IF NOT EXISTS `ocorrencias` (
  ...
  `fknuapolice` int(10) unsigned NOT NULL COMMENT 'FK indicando o código do seguro que cobre o sinistro do veículo',
...
CREATE TABLE IF NOT EXISTS `oficinas` (
  ...
  `nucepoficina` char(8) NOT NULL COMMENT 'Número do CEP do logradouro da oficina',
...
INSERT INTO `oficinas` (`pkoficina`, `txnomeoficina`, `txapelido`, `fklogradouro`, `txcomplemento`, `nucepoficina`, `dtcadoficina`) VALUES
...
CREATE TABLE IF NOT EXISTS `palavraslivros` (
  `pkpalavralivro` int(11) NOT NULL,
  ...
  `qtpalavras` smallint(5) unsigned NOT NULL,
  `qtlivros` smallint(5) unsigned NOT NULL,
...
INSERT INTO `palavraslivros` (`pkpalavralivro`, `fkpalavra`, `fklivro`, `qtpalavras`, `qtlivros`, `dtcadpallivro`) VALUES
	(1, 2, 1, 1500, 300, '2018-05-22'),
	(2, 3, 1, 400, 250, '2018-05-22');
...
CREATE TABLE IF NOT EXISTS `planosdesaude` (
  ...
  `txcomplemento` varchar(80) NOT NULL COMMENT 'Número do imóvel, localização referencial (outros imóveis próximos)',
  `nucepplanodesaude` char(8) NOT NULL COMMENT 'Número do CEP',
...
INSERT INTO `planosdesaude` (`pkplanodesaude`, `txnomeplano`, `txrazaosocial`, `fklogradouro`, `txcomplemento`, `nucepplanodesaude`, `dtcadplanosaude`) VALUES
...
INSERT INTO `planostels` (`pkplanostel`, `fkplanodesaude`, `fktelefonetipo`, `nutelefone`, `dtcadplanostel`) VALUES
	(1, 5, 4, '14875634521', '2010-10-10'),
	(2, 5, 3, '14975234152', '2010-10-10'),
	(3, 5, 2, '149512451235', '2010-10-10'),
	(4, 5, 1, '14933266523', '2010-10-10'),
	(5, 4, 4, '14962519584', '2010-10-10'),
	(6, 4, 6, '14842536251', '2010-10-10'),
	(7, 4, 5, '14963524152', '2010-10-10'),
	(8, 2, 4, '11984956251', '2012-12-10'),
	(9, 2, 2, '11975864253', '2012-12-12');

DROP TABLE IF EXISTS `produtos`;
CREATE TABLE IF NOT EXISTS `produtos` (
  `pkproduto` smallint(5) unsigned NOT NULL COMMENT 'PK da Tabela',
  `txnomeproduto` varchar(250) COLLATE utf8_bin NOT NULL COMMENT 'Nome completo e usual',
...
INSERT INTO `produtos` (`pkproduto`, `txnomeproduto`, `txdescricaocompleta`, `vlunitbase`, `vlunitminimo`, `qtestoque`, `vlunitpromocao`, `qtdiaspromocao`, `dtcadproduto`) VALUES
...
INSERT INTO `projetos` (`pkprojeto`, `txsiglaprojeto`, `txnomeprojeto`, `fkprojetosuperior`, `fkdepto`, `fkfuncionarioresponsavel`, `vlestimado`, `dtinicio`, `dttermino`, `dtcadprojeto`) VALUES
	...
	(3, 'SISTGR1', 'Sistema de Geral 1', 2, 'A01', 41, 150000.00, '2017-10-25', '2018-12-10', '2017-10-20'),
	(4, 'SISTGR2', 'Sistema de Geral 2', 2, 'A01', 25, 150000.00, '2017-10-25', '2018-12-10', '2017-10-20');
...
INSERT INTO `rotasviarias` (`pkrota`, `txnomerota`, `txdescrperiodo`, `fkcidadeorigem`, `fkcidadedestino`, `dtcadrotaviaria`) VALUES
	(1, 'Osasco-Ourinhos - Raposo Tavares', 'troca', 2, 8, '2010-10-10'),
	(2, 'Ourinhos - Sao Paulo', 'Período de 2023-12-11 a 2023-12-10', 8, 1, '2023-12-10'),
	(3, 'Ourinhos - Sao Paulo', 'Período de 2023-12-11 a 2023-12-10', 8, 1, '2023-12-09');

DROP TABLE IF EXISTS `roteiros`;
CREATE TABLE IF NOT EXISTS `roteiros` (
  `pkroteiro` int(10) unsigned NOT NULL,
  `fkrota` mediumint(8) unsigned NOT NULL COMMENT 'FK indicando a rota viária e parte da PK (composta com fkcidade e nuordem)',
  `fkcidade` smallint(5) unsigned NOT NULL COMMENT 'FK indicando a cidade e parte da PK (composta com fkrota e nuordem)',
  `nuordem` smallint(5) unsigned NOT NULL COMMENT 'Número de ordem da cidade no itinerário da rota viária e parte da PK (composta com fkrota e fkcidade).',
...
INSERT INTO `roteiros` (`pkroteiro`, `fkrota`, `fkcidade`, `nuordem`, `dtcadroteiro`) VALUES
	(121, 1, 2, 1, '2010-10-10'),
	(183, 1, 8, 3, '2010-10-10'),
	(1112, 1, 11, 2, '2020-10-10');
...
CREATE TABLE IF NOT EXISTS `seguradoras` (
  ...
  `txcomplemento` varchar(80) COLLATE utf8_bin DEFAULT NULL COMMENT 'Número do imóvel, localização referencial (outros imóveis próximos)',
  `nucepseguradora` char(8) COLLATE utf8_bin DEFAULT NULL COMMENT 'Número do CEP',
...
INSERT INTO `seguradoras` (`pkseguradora`, `txnomeseguradora`, `fklogradouro`, `txcomplemento`, `nucepseguradora`, `dtcadseguradora`) VALUES
	(1, 'Transamerica', 200, ' 745', '', '2004-02-10'),
	(3, 'Mapfre', 400, ' 2345', '', '2010-02-12'),
	(5, 'Porto Seguro', 510, ' 450', '123132', '2010-10-10'),
	(6, 'Altavista Seguros', 10, '224', '98765432', '2010-10-10'),
	(7, 'Porto Seguro Adm Seg', 350, '234 cj.', '09899899', '2020-10-10');
...
CREATE TABLE IF NOT EXISTS `seguradorastels` (
  ...
  `fktelefonetipo` smallint(5) unsigned DEFAULT NULL COMMENT 'FK para a tabela tipos_telefones',
  `nutelefone` char(15) COLLATE utf8_bin NOT NULL COMMENT 'Número do telefone (somente os números)',
...
INSERT INTO `seguradorastels` (`pkseguradoratel`, `fkseguradora`, `fktelefonetipo`, `nutelefone`, `dtcadseguradoratel`) VALUES
	(1, 1, 4, '1334334123', '2020-10-10');

DROP TABLE IF EXISTS `seguros`;
CREATE TABLE IF NOT EXISTS `seguros` (
  `pknuapolice` int(10) unsigned NOT NULL COMMENT 'PK da Tabela.',
...
INSERT INTO `seguros` (`pknuapolice`, `fkcarro`, `fkseguradora`, `dtcontratacao`, `dtlimitecobertura`, `vlcobertura`, `dtcadseguro`) VALUES
	(2, 2, 1, '2021-01-05', '2022-01-05', 65000.00, '2021-01-05'),
	(124578, 1, 1, '2023-01-10', '2024-01-10', 45000.00, '2023-01-09'),
	(124581, 2, 1, '2023-01-10', '2024-01-10', 45000.00, '2023-01-09'),
	(124587, 3, 5, '2023-01-10', '2024-01-10', 45000.00, '2023-01-09'),
	(124591, 4, 6, '2023-01-10', '2024-01-10', 70000.00, '2023-01-09');
...
CREATE TABLE IF NOT EXISTS `servicos` (
  ...
  `txdescricaoservico` varchar(250) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'Texto descrevendo o setor de atuação',
...
INSERT INTO `servicos` (`pkservico`, `txnomeservico`, `txdescricaoservico`, `dtcadservico`) VALUES
...
CREATE TABLE IF NOT EXISTS `setoresdeatuacao` (
  `pksetordeatuacao` smallint(5) unsigned NOT NULL COMMENT 'PK da Tabela.',
  `txnomesetordeatuacao` varchar(90) COLLATE utf8_bin NOT NULL COMMENT 'Nome completo e sem abreviações',
  `txdescricaosetordeatuacao` varchar(250) COLLATE utf8_bin NOT NULL COMMENT 'Texto descrevendo o setor de atuação',
  `dtcadsetordeatuacao` date NOT NULL COMMENT 'Data de geração do registro'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='setatuac';

INSERT INTO `setoresdeatuacao` (`pksetordeatuacao`, `txnomesetordeatuacao`, `txdescricaosetordeatuacao`, `dtcadsetordeatuacao`) VALUES
...
CREATE TABLE IF NOT EXISTS `sinistros` (
  ...
  `txdescricaosinitro` varchar(250) COLLATE utf8_bin NOT NULL COMMENT 'Texto descrevendo o sinistro que pode ocorrer em um veículo (incêndio, roubo, etc)',
...
INSERT INTO `sinistros` (`pksinistro`, `txnomesinistro`, `txdescricaosinitro`, `dtcadsinistro`) VALUES
...
CREATE TABLE IF NOT EXISTS `tarefasprojetos` (
  `pktarefaprojeto` smallint(5) unsigned NOT NULL COMMENT 'PK da tabela',
...
INSERT INTO `tarefasprojetos` (`pktarefaprojeto`, `fkprojeto`, `fktarefa`, `qthorasenvolvidas`, `nuordemtarefa`, `dtcadtarefaprojeto`) VALUES
	...
	(57, 3, 8, 23, 2, '2022-12-12'),
	(58, 3, 11, 20, 255, '2022-12-13');

DROP TABLE IF EXISTS `telefonestipos`;
CREATE TABLE IF NOT EXISTS `telefonestipos` (
  `pktelefonetipo` smallint(6) unsigned NOT NULL COMMENT 'PK da Tabela',
  `txnometelefonetipo` varchar(250) COLLATE utf8_bin NOT NULL COMMENT 'Texto descrevendo o tipo de telefone',
...
INSERT INTO `telefonestipos` (`pktelefonetipo`, `txnometelefonetipo`, `dtcadtelefonetipo`) VALUES
...
INSERT INTO `titulacoes` (`pktitulacao`, `fkprofessor`, `fktitulo`, `dtcadtitulacao`) VALUES
	(1, 1, 5, '2022-12-06'),
	(2, 1, 5, '2022-12-06'),
	(3, 2, 6, '2010-10-10'),
	(4, 35, 6, '2012-12-20');
...
CREATE TABLE IF NOT EXISTS `veiculos` (
  ...
  `fkveiculotipo` smallint(6) unsigned DEFAULT NULL COMMENT 'FK indicando o código do tipo de veiculo.',
  `fkfuncionario` smallint(5) unsigned DEFAULT NULL COMMENT 'FK indicando o código do funcionário.',
  `fkveiculomodelo` smallint(5) unsigned DEFAULT NULL COMMENT 'FK indicando o código do modelo.',
...
INSERT INTO `veiculos` (`pkveiculo`, `fkveiculotipo`, `fkfuncionario`, `fkveiculomodelo`, `fkcor`, `ukplaca`, `aotipo`, `txapelido`, `qtcapacidade`, `aostatus`, `nuanofabricacao`, `dtcadveiculo`) VALUES
	(1, 1, 1, 1, 1, 'ABC1234', 'C', '', 5, 'A', '2020', '2022-11-24'),
	(2, 1, 2, 2, 1, 'AFD3453', 'C', '', 5, 'A', '2021', '2022-11-24'),
	(3, 1, 1, 3, 2, 'WRE2366', 'C', '', 5, 'A', '1998', '2022-11-24'),
	(4, 1, 3, 4, 2, 'SWD4553', 'C', '', 6, 'A', '2018', '2022-11-24'),
	(5, 1, 4, 7, 3, 'XDV2669', 'C', '', 7, 'A', '2022', '2022-11-24');

DROP TABLE IF EXISTS `veiculosmarcas`;
CREATE TABLE IF NOT EXISTS `veiculosmarcas` (
  `pkveiculomarca` smallint(5) unsigned NOT NULL COMMENT 'PK da Tabela.',
...
INSERT INTO `veiculosmarcas` (`pkveiculomarca`, `txnomemarca`, `fkfabricante`, `dtcadmarca`) VALUES
	(1, 'Gol', 1, '2022-11-24'),
	(2, 'Chevette', 2, '2022-11-24'),
	(3, 'Nivus', 1, '2022-11-24'),
	(4, 'Taos', 1, '2022-11-24');

DROP TABLE IF EXISTS `veiculosmodelos`;
CREATE TABLE IF NOT EXISTS `veiculosmodelos` (
  `pkveiculomodelo` smallint(5) unsigned NOT NULL COMMENT 'PK da Tabela',
  `fkveiculomarca` smallint(5) unsigned DEFAULT NULL COMMENT 'FK com o código da marca de veiculos feitos por fabricantes',
...
INSERT INTO `veiculosmodelos` (`pkveiculomodelo`, `fkveiculomarca`, `txdescricaomodelo`, `aotipocombustivel`, `dtcadmodelo`) VALUES
	(1, 1, '1.0', 'G', '2022-11-24'),
	(2, 1, '2.0 Plus', 'F', '2022-11-24'),
	(3, 2, 'Plus', 'F', '2022-11-24'),
	(4, 2, 'S', 'G', '2022-11-24'),
	(5, 3, 'Highline', 'F', '2022-11-24'),
	(6, 3, 'Highline', 'F', '2022-11-24'),
	(7, 4, '350Si', 'F', '2022-11-24');
...
CREATE TABLE IF NOT EXISTS `veiculostipos` (
  ...
  `txdescricaoveiculotipo` varchar(250) COLLATE utf8_bin NOT NULL COMMENT 'Texto descrevendo o tipo de veiculo (carro, caminhonete, motocicleta, etc)',
...
INSERT INTO `veiculostipos` (`pktipoveiculo`, `txdescricaoveiculotipo`, `dtcadveiculotipo`) VALUES
...
INSERT INTO `viagens` (`pkviagem`, `fkonibus`, `fkrota`, `dtviagem`, `hrsaida`, `dtcadviagem`) VALUES
	(1, 1, 2, '2023-12-11', '08:00:00', '2023-12-10');
